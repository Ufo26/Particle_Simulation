...
namespace UFO {
    ...
    public class RANDOM {
        ...
        /// <summary> <inheritdoc cref="RND"/> </summary>
        /// <value> <inheritdoc cref="RND"/> </value>
        /// <returns> Возвращает случайное число uint в диапазоне [+min .. +max]. <br/>
        ///     При min > max поведение функции нарушится. Проверка не встроена. <br/>
        ///     Корректный ввод: min меньше или равно max.
        /// </returns>
        public uint uRND(uint min, uint max) { return uRND() % (max - min + 1) + min; }
